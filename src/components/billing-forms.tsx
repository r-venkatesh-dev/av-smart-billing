...
export function BillingPaymentForm({ invoices, defaultInvoiceId = "", paymentQrUrl = "" }: { invoices: { id: string; invoiceNumber: string; customerName: string; outstandingInPaise: number }[]; defaultInvoiceId?: string; paymentQrUrl?: string }) {
