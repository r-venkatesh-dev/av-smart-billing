import { Check, ReceiptIndianRupee, ShieldCheck } from "lucide-react";
...
export default async function LoginPage({ searchParams }: PageProps<"/login">) {
  ...
  return <main className="grid min-h-screen lg:grid-cols-[1.05fr_.95fr]">
    <section className="relative hidden overflow-hidden bg-[#171b36] p-12 text-white lg:flex lg:flex-col lg:justify-between">
      ...
      <div className="relative flex items-center gap-3"><span className="grid size-10 place-items-center rounded-xl bg-[#6558ff]"><ReceiptIndianRupee size={22} /></span><span className="text-xl font-bold">AV Smartbilling</span></div>
    ...
    <section className="flex items-center justify-center bg-[#f7f8f7] px-5 py-12 sm:px-10"><div className="w-full max-w-[410px]">
      <div className="mb-9 flex items-center gap-3 lg:hidden"><span className="grid size-9 place-items-center rounded-xl bg-[#5b4df5] text-white"><ReceiptIndianRupee size={20} /></span><span className="text-lg font-bold">AV Smartbilling</span></div>
