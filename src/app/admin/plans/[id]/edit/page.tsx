...
export default async function EditPlanPage({ params }: PageProps<"/admin/plans/[id]/edit">) {
  ...
  if (!plan) notFound();
  return <div className="space-y-7"><PageHeader backHref="/admin/plans" eyebrow="Configuration" title="Edit plan" description="Update this licensing plan in Supabase." /><PlanForm plan={plan} /></div>;
}
