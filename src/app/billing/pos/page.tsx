...
import { listBillingCustomers, listBillingHeldBills, listBillingProducts } from "@/data/billing";

export default async function Page() {
  const [customerData, productData, heldData] = await Promise.all([listBillingCustomers(), listBillingProducts(), listBillingHeldBills()]);
