...
export default async function Page({ searchParams }: PageProps<"/billing/payments/new">) {
  ...
  return <div className="mx-auto max-w-4xl space-y-7"><PageHeader backHref="/billing/payments" eyebrow={business.companyName} title="Record payment" description="Apply a receipt to an outstanding invoice." /><BillingPaymentForm invoices={outstanding} defaultInvoiceId={selectedInvoiceId} /></div>;
}
